...
CREATE TABLE `secure_user` (
  ...
  `user_type` int(11) DEFAULT '0' COMMENT '用户类型：0二手房东 1房东  2二手房东和房东',
  PRIMARY KEY (`id`),
...
INSERT INTO `secure_user` VALUES (3,'2017-12-14 14:55:33',NULL,'2017-12-14 14:55:33',NULL,NULL,'cobee','d1465a4fed4a138f074b3490a5574b48','18027041862',0,'陈淦森',1,0),(4,'2017-12-16 18:06:03',NULL,'2017-12-16 18:06:03',NULL,NULL,'admin','68a43d1a89793013cfa3425717aa190a','18027041863',NULL,'admin',0,0);
